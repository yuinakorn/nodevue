<template>
  <header class="p-3 border-bottom shadow-lg">
    ...
    <div class="container-fluid d-flex justify-content-between">
      ...
      <div class="d-flex">
        ...
        <ul class="nav col-sm-auto col-md-auto col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="#" class="nav-link px-2 link-secondary">main {{ appName }}</a></li>
          <li><a href="#" class="nav-link px-2 link-dark">second </a></li>
          <li><a href="#" class="nav-link px-2 link-dark">third</a></li>
        </ul>
      </div>
      <div class="d-flex">
